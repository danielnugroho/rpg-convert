...
json0 = "[ \"" + input_file + "\", {" + \
    "\"type\":\"writers.copc\", \"filename\":\"" + copc_file + "\" } ]"

# Execute the pipeline using PDAL
pipeline0 = pdal.Pipeline(json0)
count = pipeline0.execute()
...
json1 = "[" + "\"" + copc_file + "\",{\"type\":\"filters.transformation\"," + \
        "\"matrix\":\"" + thelist +"\"" + \
        "},\"" + output_file + "\"" + "]"
